<template>
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_2805_14835)">
      <g clip-path="url(#clip1_2805_14835)">
        <path
          ...
          :stroke="props.isActive ? '#7366FF' : '#2C323F'"
          stroke-opacity="0.8"
          stroke-width="1.5"
    ...
    <defs>
      <clipPath id="clip0_2805_14835">
        <rect width="18" height="18" fill="white" />
      </clipPath>
      <clipPath id="clip1_2805_14835">
        <rect width="18" height="18" fill="white" />
      </clipPath>
    </defs>
  </svg>
